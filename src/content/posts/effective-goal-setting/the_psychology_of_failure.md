...
The previous two pieces established a structure (the top is underpriced, take cheap bets to capture it) and noted the obvious objection: if the math is this straightforward, why doesn't everyone do it? The answer is that knowing the math does not change the psychology. This piece is about the psychology.
