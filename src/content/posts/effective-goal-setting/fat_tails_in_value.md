...
- [Taking Asymmetric Bets](/effective-goal-setting/taking_asymmetric_bets): Given that the top is underpriced, how do you actually capture that value? The mechanism involves volume, low opportunity cost per bet, and a tolerance for repeated failure.
- [The Psychology of Failure](/effective-goal-setting/the_psychology_of_failure): Fear of failure is the largest factor pushing people away from the top. What does it actually take to act in the presence of that fear?
