...
|--------|---------|------------|
| Universal background checks | ~90% public support | NRA, some conservatives |
| Assault weapons ban | Mixed public support | Strong conservative opposition |
| Red flag laws | Growing support | Due process concerns |
| Concealed carry expansion | Conservative priority | Liberal opposition |
| "Constitutional carry" | Growing in red states | Safety concerns |
